    ...
    <section id="pricing-order" className="scroll-mt-12">
      <div className="bg-[#f5f5f7] py-16 sm:py-24">
        <div className="container">
          ...
          {/* ── Section header: bỏ label lặp, giữ 1 tiêu đề + mô tả gọn ── */}
          <div className="text-center">
            <h2 className="text-section-title text-[#1d1d1f]">
              {t.pricingOrder.heading}
            </h2>
            <p className="mx-auto mt-3 max-w-[26rem] text-base leading-relaxed text-[#86868b]">
              {t.pricingOrder.sub}
            </p>
          </div>

          {/* ── Main card: 2 cột — ảnh trái | giá phải ── */}
          <div className="mx-auto mt-10 flex max-w-3xl flex-col overflow-hidden rounded-3xl bg-white shadow-md sm:flex-row">

            {/* LEFT — hình ảnh thực tế sản phẩm */}
            <div className="flex items-center justify-center bg-[#eef2ff] p-8 sm:w-[42%]">
              <img
                src={imgMain}
                alt="Thiết bị BA.SEW"
                width={220}
            ...
            <div className="flex flex-1 flex-col p-7 sm:p-9">
              ...
              <button
                ...
                className="mt-7 inline-flex h-12 w-full items-center justify-center gap-2 rounded-full bg-[#0071e3] text-[15px] font-semibold text-white shadow-sm transition-all hover:bg-[#005bbf] active:scale-[0.98]"
              >
              ...
              <div className="mt-4 flex items-center gap-1.5 text-xs text-[#86868b]">
          ...
          <div className="mx-auto mt-6 flex max-w-3xl flex-wrap items-center justify-center gap-x-6 gap-y-2 text-sm text-[#86868b]">
